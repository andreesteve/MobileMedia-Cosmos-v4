...
import br.unicamp.ic.sed.mobilemedia.impl.filesystemmgr.spec.excep.InvalidArrayFormatException;
 ...
 class ImageUtil {
	...
	public ImageData getImageInfoFromBytes(byte[] bytes)
		...
		try {
			...
			// delimeter
			//System.out.println("[ImageUtil] startIndex:"+startIndex+" endIndex:"+endIndex);
			...
			try {
				...
				System.out.println("[ImageUtil]Error: index out of bounds!" );
				e.printStackTrace();
			}
			// #endif
