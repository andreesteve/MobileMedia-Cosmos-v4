...
import br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.spec.excep.ImageNotFoundException;
import br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.spec.excep.InvalidImageDataException;
import br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.spec.excep.InvalidPhotoAlbumNameException;
import br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.spec.excep.NullAlbumDataReference;
import br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.spec.excep.PersistenceMechanismException;
import br.unicamp.ic.sed.mobilemedia.impl.mobilephotomgr.spec.excep.UnavailablePhotoAlbumException;
